...
public class Exercise03{
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.printf("What is your choice? \n %s \n %s \n %s \n %s \n %s \n %s \n %s \n %s", "0: Rock", "1: Paper", "2: Scissors", "3: Spock", "4: Lizard", "5: Save and Exit", ": ");
            try {
    ...
    public static void fileCreate() {
        ...
        try {
            ...
            myWriter.write(startingUserValue);
            myWriter.write("\n");
            myWriter.write(startingComputerValue);
    ...
    public static void newScoreAppend(){
        String textToAppend = "\r\n" ;

        File saveToFile = new File("SaveFile.txt");
    ...
    public static void readData(){
        ...
        try {
            ...
            userScore = Integer.valueOf(storage[0]);
            computerScore = Integer.valueOf(storage[1])
            }
